...
export default function SavingsGoalsPage({
  ...
  const handleAddMoneySubmit = async (e) => {
    ...
    try {
      const currentVal =
        Number(
          selectedGoal.current_amount || selectedGoal.current
        ) || 0
      ...
      setAddMoneyError(
        err.message || 'Failed to update goal amount.'
      )
    }
  }
  ...
  return (
    <div className="w-full max-w-full lg:w-full lg:max-w-none space-y-6 select-none animate-fade-in pb-8">
      {/* =========================================================
          HEADER
      ========================================================== */}
      ...
      <ScrollFadeIn delay={100}>
        <div
          className={`w-full lg:w-full p-3.5 sm:p-4 rounded-2xl border shadow-sm transition-colors ${
            isLight
        ...
        >
          <div
            className={`flex items-center justify-between pb-2.5 border-b text-[11px] font-bold uppercase tracking-wider ${
              isLight
          ...
          <div className="grid grid-cols-4 gap-0.5 pt-2.5 items-center">
            <div className="text-center sm:text-left space-y-0.5">
              ...
              <span
                className={`text-xs sm:text-sm md:text-base font-bold font-mono block truncate ${
                  isLight
                    ? 'text-[#343A40]'
                    : 'text-[#F1F3F5]'
                }`}
              >
                ₱
                {overviewMetrics.totalSaved.toLocaleString(
                  'en-US',
                  {
            ...
            <div
              className={`text-center sm:text-left space-y-0.5 border-l sm:pl-3 ${
                isLight
                  ? 'border-[#DEE2EA]'
                  : 'border-[#242830]'
              }`}
            >
              ...
              >
                ₱
                {overviewMetrics.totalRemaining.toLocaleString(
                  'en-US',
                  {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
            ...
            <div
              className={`text-center sm:text-left space-y-0.5 border-l pl-2 sm:pl-3 ${
                isLight
                  ? 'border-[#DEE2EA]'
                  : 'border-[#242830]'
              }`}
            >
              ...
              <span
                className={`text-xs sm:text-sm md:text-base font-bold font-mono block ${
                  isLight
                    ? 'text-[#343A40]'
                    : 'text-[#F1F3F5]'
                }`}
      ...
      {/* =========================================================
          FILTER + NEW GOAL
          Desktop: stable full width alignment
      ========================================================== */}
      <div className="flex flex-wrap items-center justify-between gap-3 pt-1 lg:w-full">
        <div
          ...
          {[
            ...
            return (
              <button
                ...
                className={`py-1.5 px-4 rounded-xl text-xs font-semibold transition-all cursor-pointer text-center ${
                  isActive
                    ? isLight
        ...
        <button
          ...
          className={`flex items-center gap-2 py-2 px-4 rounded-2xl text-xs font-bold shadow-md transition-all active:scale-[0.985] cursor-pointer ${
            isLight
      ...
      {filteredGoals.length === 0 && (
        <div
          className={`p-8 sm:p-12 text-center rounded-3xl border space-y-4 my-4 animate-fade-in ${
            isLight
              ? 'bg-[#F1F3F8] border-[#DEE2EA] text-[#343A40]'
              : 'bg-[#121418] border-[#242830] text-[#F1F3F5]'
          }`}
        >
          <div
            className={`w-14 h-14 rounded-3xl mx-auto flex items-center justify-center border ${
              isLight
          ...
          <div className="pt-2">
            <button
              onClick={handleOpenCreateModal}
              className={`py-2.5 px-5 rounded-2xl font-bold text-xs shadow-md transition-all active:scale-[0.985] cursor-pointer inline-flex items-center gap-2 ${
                isLight
                  ? 'bg-[#343A40] text-[#F8F8FF] hover:bg-[#212529]'
                  : 'bg-[#F1F3F5] text-[#000000] hover:bg-white'
              }`}
      ...
      {/* =========================================================
          GOAL GRID
          Mobile: unchanged
          Desktop: explicit 2-column layout
      ========================================================== */}
      {filteredGoals.length > 0 && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-5 lg:gap-5 w-full min-w-0">
          {filteredGoals.map((goal) => {
            const targetVal =
              Number(goal.target_amount || goal.target) || 1

            const currentVal =
              Number(goal.current_amount || goal.current) || 0

            const remainingVal = Math.max(
              0,
            ...
            const isCompleted =
              targetVal > 0 && currentVal >= targetVal
            ...
            return (
              <div
                ...
                className={`min-w-0 w-full p-5 rounded-3xl border flex flex-col justify-between space-y-4 transition-all duration-200 cursor-pointer group hover:shadow-lg active:scale-[0.99] ${
                  isCompleted
                    ? isLight
              ...
              >
                <div className="space-y-3 min-w-0">
                  ...
                  <div className="flex items-center justify-between text-xs pt-0.5 gap-3">
                    <span
                ...
                <div className="pt-3 border-t border-black/5 dark:border-white/5 flex items-center gap-2">
                  {!isCompleted ? (
                    <>
                      <button
                        onClick={(e) =>
                          handleOpenAddMoneyModal(goal, e)
                        }
      ...
      {isCreateModalOpen &&
        createPortal(
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 select-none animate-fade-in">
            ...
            <div
              className={`relative w-full max-w-md sm:max-w-md rounded-3xl border p-5 sm:p-6 shadow-2xl z-10 transition-all ${
                isLight
                  ? 'bg-[#F1F3F8] border-[#DEE2EA] text-[#343A40]'
                  : 'bg-[#121418] border-[#242830] text-[#F1F3F5]'
              }`}
              ...
              >
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative flex items-center">
                    <span
                      className={`absolute left-4 text-base font-bold font-mono ${
                        isLight
                          ? 'text-[#4B535E]'
                          : 'text-[#D1D5DB]'
                      }`}
                    ...
                    <input
                      ...
                      className={`w-full py-2.5 pl-9 pr-4 rounded-2xl text-sm font-mono font-bold outline-none border transition-all ${
                        isLight
                          ? 'bg-[#F4F5FA] border-[#DEE2EA] text-[#343A40] focus:border-[#343A40]'
                          : 'bg-[#181b20] border-[#242830] text-[#F1F3F5] focus:border-[#F1F3F5]'
                      }`}
                ...
                <div className="flex items-center gap-3 pt-3">
                  ...
                  <button
                    ...
                    className={`flex-1 py-2.5 px-4 rounded-2xl font-bold text-xs shadow-md transition-all active:scale-[0.985] cursor-pointer ${
                      isLight
                        ? 'bg-[#343A40] text-[#F8F8FF] hover:bg-[#212529]'
                        : 'bg-[#F1F3F5] text-[#000000] hover:bg-white'
                    }`}
            ...
            >
              ...
              >
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative flex items-center">
                    <span
                      className={`absolute left-4 text-lg font-bold font-mono ${
                        isLight
                          ? 'text-[#4B535E]'
                          : 'text-[#D1D5DB]'
                      }`}
                ...
                <div className="space-y-4 pt-4">
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    <button
                      ...
                      className={`w-full py-3 px-4 rounded-2xl font-bold text-xs shadow-md transition-all active:scale-[0.985] cursor-pointer flex items-center justify-center gap-2 ${
                        isLight
                          ? 'bg-[#343A40] text-[#F8F8FF] hover:bg-[#212529]'
                          : 'bg-[#F1F3F5] text-[#000000] hover:bg-white'
                      }`}
                ...
                >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className={`w-full py-2.5 px-4 rounded-2xl text-sm font-mono font-bold outline-none border transition-all ${
                        isLight
                          ? 'bg-[#F4F5FA] border-[#DEE2EA] text-[#343A40]'
                          : 'bg-[#181b20] border-[#242830] text-[#F1F3F5]'
                      }`}
