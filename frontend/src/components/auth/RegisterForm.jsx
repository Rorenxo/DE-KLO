  ...
  return (
    <div className="w-full space-y-4 sm:space-y-5 animate-fade-in">
      ...
      <button
        ...
        disabled={isLoading}
        className="w-full min-h-[44px] py-2.5 px-4 bg-[#24292e]/60 hover:bg-[#24292e] border border-[#4a5156] hover:border-[#808a92] text-white font-medium text-xs sm:text-sm rounded-2xl flex items-center justify-center gap-3 transition-all duration-200 cursor-pointer disabled:opacity-50"
      >
        <GoogleIcon />
